                ...
                <nav className="navbar navbar-dark navbar-expand-lg">
                    <div className="container">
                        <a className="navbar-brand" href="index.html">
                            <span><img src="images/logo-amarela.png" alt="" /></span>
                        </a>

                        <div className="d-lg-none ms-auto me-4">
                            <a href="login-form-15/index.html" className="navbar-icon bi-person smoothscroll"></a>
                        </div>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav ms-lg-5 me-lg-auto">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link click-scroll" href="#section_2">Mais Visitados</a>
                                </li>

                                <li className="nav-item">
                                    <a className="nav-link click-scroll" href="#section_3">Como funciona?</a>
                                </li>

                                <li className="nav-item">
                                    <a className="nav-link click-scroll" href="#section_4">Dúvidas?</a>
                                </li>

                                <li className="nav-item">
                                    <a className="nav-link click-scroll" href="#section_5">Contato</a>
                                </li>

                                <li className="nav-item dropdown">
                                    <a className="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLink" role="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">Cursos</a>

                                    <ul className="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                        <li><a className="dropdown-item" href="topics-listing.html">Desenvolvimento WEB</a></li>

                                        <li><a className="dropdown-item" href="contact.html">Business Inteligence</a></li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-8 col-12 mx-auto">
                                <h1 className="text-white text-center">Pesquise, estude e
                                    <br />
                                </h1>
                                <h1 className="text-warning text-center">NOTA EXTRA!</h1>

                                <h6 className="text-center">Uma plataforma feita para garantir seu ponto extra no semestre.</h6>
                                ...
                                <form method="get" className="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search">
                                    <div className="input-group input-group-lg">
                                        ...
                                        <input name="keyword" type="search" className="form-control" id="keyword"
                                            placeholder="Design, Programação, Marketing, Finanças..." aria-label="Search" />
                                ...
                                <div className="custom-block bg-white shadow-lg">
                                    <a href="topics-detail.html">
                                        <div className="d-flex">
                                            <div>
                                                <h5 className="mb-2">Desenvolvimento WEB</h5>

                                                <p className="mb-0">Aprenda o básico de desenvolvimento web, front-end e back-end, e
                                                    conheça as principais tags de CSS, além de conhecer os principais códigos de
                                                    JavaScript para criar seu primeiro site!</p>
                                            </div>
                                ...
                                <div className="custom-block custom-block-overlay">
                                    <div className="d-flex flex-column h-100">
                                        ...
                                        <div className="custom-block-overlay-text d-flex">
                                            <div>
                                                <h5 className="text-white mb-2">Finanças</h5>
                                                <p className="text-white">Aprenda utilizar o Excel para organizar suas finanças,
                                                    conheça os termos mais utilizados nesse mundo e, também, aprenda sobre
                                                    investimentos, seus principais pontos e os como analisar um investimento!
                                                </p>
                                        ...
                                        <div className="social-share d-flex">
                                            <p className="text-white me-4">Compartilhe:</p>
                ...
                <section className="explore-section section-padding" id="section_2">
                    <div className="container">
                        <div className="col-12 text-center">
                            <h2 className="mb-4">OS MAIS VISITADOS</h2>
                        </div>
                        ...
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="finance-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="finance-tab-pane" aria-selected="false">Finanças</button>
                            </li>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className="tab-content" id="myTabContent">
                                ...
                                <div className="tab-pane fade" id="marketing-tab-pane" role="tabpanel"
                                ...
                                <div className="tab-pane fade" id="finance-tab-pane" role="tabpanel"
                                                ...
                                                <div className="d-flex flex-column h-100">
                                                    ...
                                                    <div className="custom-block-overlay-text d-flex">
                                                        <div>
                                                            ...
                                                            <a href="topics-detail.html"
                                                                className="btn custom-btn mt-2 mt-lg-3">Learn More</a>
                                                        </div>
                                ...
                                <div className="tab-pane fade" id="education-tab-pane" role="tabpanel"
